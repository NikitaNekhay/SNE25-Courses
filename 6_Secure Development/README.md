...
> Building security into the development lifecycle: pipelines, code, fuzzing, monitoring and hardening.

**Program:** Security and Network Engineering — Innopolis University
**Performed by:** Nikita Niakhai (M25-SNE-01)
...
| 5 | MAC: AppArmor & SELinux | [report](1_Labs/5_MAC_AppArmor_SELinux/AppArmSELinux_LAB_5_Nikita_Niakhai.md) | Mandatory access control theory, CIS benchmark MAC controls, GRUB kernel parameters, profiles |
| 6 | Penetration testing | [report](1_Labs/6_Penetration_Testing/Penetration_LAB_6_Nikita_Niakhai.md) | Full engagement against the DevGuru target machine: recon, exploitation, privilege escalation |
