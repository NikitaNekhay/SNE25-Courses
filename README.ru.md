...
| 10 | [Индустриальный проект — Flexible Platform](./10_Industrial%20Project/README.md) | командный конструктор сценариев для кибер-полигона заказчика Innostage: визуальный редактор многоэтапных цепочек атак на Sliver C2 + MITRE ATT&CK Atomic Red Team. Моя роль — фронтенд и тимлид. |
